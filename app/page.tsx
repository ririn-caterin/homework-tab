      ...
      <div>
        {
          tab === "profile" ? (
            <div className="m-4">
              ...
              <div className="my-8">
                <Image src="https://pbs.twimg.com/profile_images/1434881675255861248/Grx8VDTK_400x400.jpg" alt="Image Profile" width={240} height={240} className="outline outline-black outline-offset-2 outline-2 rounded-2xl"/>
